...
| DOCS | 14 | 17 | README, DECISIONS.md seed, PROTOCOL.md (wire protocol + on-disk format), CONTRACTS.md. | [SPEC/DOCS/epic.md](SPEC/DOCS/epic.md) |
...
| IDEM | 18 | 31 | Every mutating operation carries a client-supplied idempotency key and is safe to retry, per invariant 10 (CL… | [SPEC/IDEM/epic.md](SPEC/IDEM/epic.md) |
