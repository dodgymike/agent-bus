...
- [ ] None · DEPLOY-2-FU-CONTAINERNAME: docker-compose.yml hardcodes container_name, collides with any other compose project using the same name — deploy, P1
...
- [~] IDEM-10 · IDEM-10: Idempotency key -- format, client-supplied untrusted validation, scoped per-agent — core, P1, in progress
...
- [~] RELAY-1 · RELAY-1: Peer enrolment + initial agent-list exchange — relay, P2, in progress
...
- [~] SIGN-1 · SIGN-1: Canonical signing format for messages (Ed25519 detached signatures) — crypto, P1, in progress
