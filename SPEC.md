...
**849 tasks in 32 epics — 540 open, 309 closed.**
...
| CONV | 15 | 18 | Server-minted, server-tracked, multi-party CONVERSATIONS: a durable first-class object a client | [SPEC/CONV/epic.md](SPEC/CONV/epic.md) |
