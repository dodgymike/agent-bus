...
| ADMIN-3 | ADMIN-3: \`agent-busadm serve\` -- loopback-only console with a capability token and an emb… | todo | P2 | [task.md](ADMIN-3--76bfce36/task.md) | — | [ADMIN-1](ADMIN-1--db334b3c/task.md) [ADMIN-2](ADMIN-2--786e0de1/task.md) [ADMIN-4](ADMIN-4--e12b4149/task.md) [ADMIN-C2](ADMIN-C2--d31d77ff/task.md) [INVITE-GATE](../INVITE/INVITE-GATE--05a5216d/task.md) |
...
| ADMIN-8 | ADMIN-8: GET /v1/status -- authenticated, in-process counters, exhaustive field-set pin,… | todo | P3 | [task.md](ADMIN-8--7f550309/task.md) | supersedes [CORE-5](../CORE/CORE-5--06c5b1f5/task.md) | [ADMIN-2](ADMIN-2--786e0de1/task.md) [CORE-5](../CORE/CORE-5--06c5b1f5/task.md) [INVITE-GATE](../INVITE/INVITE-GATE--05a5216d/task.md) |
