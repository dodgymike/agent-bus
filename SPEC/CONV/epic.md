...
**15 open / 18 total.** Full records live in `SPEC/CONV/<task>/task.md`.
...
| CONV-CREATE-CLI | CONV-CREATE-CLI: mint a conversation -- HTTP route + agent-busctl subcommand + AGENT_PROT… | todo | P2 | [task.md](CONV-CREATE-CLI--627d20e0/task.md) | blocked by [CONV-RECORD](CONV-RECORD--cd3524c2/task.md)<br>blocks [CONV-SEND-BY-ID](CONV-SEND-BY-ID--ce8bff7b/task.md) | [SIGN-6](../SIGN/SIGN-6--c9e4aea1/task.md) [CONV-RECORD](CONV-RECORD--cd3524c2/task.md) |
...
| CONV-RECORD | CONV-RECORD: the durable conversation record -- wal.Entry.Kind "conversation" (reservatio… | todo | P2 | [task.md](CONV-RECORD--cd3524c2/task.md) | blocked by [CONV-ID-SHAPE](CONV-ID-SHAPE--8914a5d8/task.md)<br>blocked by [CONV-NAME-INV6](CONV-NAME-INV6--a11d59cd/task.md)<br>blocks [CONV-CRASH](CONV-CRASH--3078ad4e/task.md)<br>blocks [CONV-CREATE-CLI](CONV-CREATE-CLI--627d20e0/task.md)<br>blocks [CONV-MEMBER-CHANGE](CONV-MEMBER-CHANGE--03ebeed2/task.md) | [CONV-ID-SHAPE](CONV-ID-SHAPE--8914a5d8/task.md) [CONV-NAME-INV6](CONV-NAME-INV6--a11d59cd/task.md) [CONV-MEMBER-CHANGE](CONV-MEMBER-CHANGE--03ebeed2/task.md) [CONV-CRASH](CONV-CRASH--3078ad4e/task.md) |
| CONV-SEND-BY-ID | CONV-SEND-BY-ID: address a conversation by id instead of tracking participants -- route +… | todo | P2 | [task.md](CONV-SEND-BY-ID--ce8bff7b/task.md) | blocked by [CONV-CREATE-CLI](CONV-CREATE-CLI--627d20e0/task.md) | [CONV-CREATE-CLI](CONV-CREATE-CLI--627d20e0/task.md) |
