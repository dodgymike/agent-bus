...
**7 open / 9 total.** Full records live in `SPEC/SIGN/<task>/task.md`.
...
| SIGN-5 | SIGN-5: MANDATORY negative-test suite -- prove the verifier rejects everything it must | todo | P1 | [task.md](SIGN-5--5cedc580/task.md) | blocks [CRYPTO-10](../CRYPTO/CRYPTO-10--68ff679d/task.md) | [SIGN-1](SIGN-1--43fd21ae/task.md) [SIGN-2](SIGN-2--1c183f10/task.md) [CRYPTO-10](../CRYPTO/CRYPTO-10--68ff679d/task.md) [SIGN-4](SIGN-4--33fa35d8/task.md) |
