...
| Updated | 2026-08-14T11:38:52.054088+00:00 |
| Completed | — |

## Proof command

```sh
go test -race -run 'TestEnrolBindsClientCertFingerprint|TestEnrolRejectsAlreadyBoundFingerprint|TestClientCertCannotInfluenceAgentID' ./internal/auth ./internal/httpapi && grep -qi 'fingerprint' CONTRACTS-HTTP.md
```
